/*
sample code for vulnerability type : Cross-Site Request Forgery (CSRF)
CWE : CWE-352
Description : The provided code does not have CSRF protection enabled for your Express app. This allows attackers to execute requests on a user's behalf.
*/
...
const app: Express = express()  //Source and Sink
